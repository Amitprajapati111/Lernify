                                            ...
                                            return (
                                                <tr key={sub._id} className="hover:bg-slate-50 transition">
                                                    ...
                                                    <td className="px-6 py-4 text-center">
                                                        {sub.fileUrl ? (
                                                            <a href={`http://localhost:5000${sub.fileUrl}`} target="_blank" rel="noreferrer" className="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium bg-primary-50 px-3 py-1 rounded transition">
